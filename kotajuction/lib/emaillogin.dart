          ...
          child: Column(
            ...
            children: [
                  ...
                  Padding(
                    ...
                    child: Text("And, Your Email ?",style: TextStyle(fontSize:21,color: Colors.black,fontWeight: FontWeight.bold ),),
                  ),
                  SizedBox(height: 50,),
                  Row(
                    children: [
             ...
             height: 54,
               child: ElevatedButton(
                      ...
                      child: Padding(
                        ...
                        child: Text("Verify Your Email",style: TextStyle(color: const Color.fromARGB(255, 226, 225, 225),fontSize: 18),),
                      ),
                      style: ButtonStyle(
